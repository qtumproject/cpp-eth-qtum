        ...
        class DebugFace : public ServerInterface<DebugFace>
        {
            public:
                DebugFace()
                {
                    ...
                    this->bindAndAddMethod(jsonrpc::Procedure("debug_storageAt", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_STRING,"param2",jsonrpc::JSON_INTEGER,"param3",jsonrpc::JSON_STRING,"param4",jsonrpc::JSON_STRING,"param5",jsonrpc::JSON_STRING,"param6",jsonrpc::JSON_INTEGER, NULL), &dev::rpc::DebugFace::debug_storageAtI);
                ...
                {
                    response = this->debug_storageAt(request[0u].asString(), request[1u].asInt(), request[2u].asString(), request[3u].asString(), request[4u].asString(), request[5u].asInt());
                }
                ...
                virtual Json::Value debug_storageAt(const std::string& param1, int param2, const std::string& param3, const std::string& param4, const std::string& param5, int param6) = 0;
